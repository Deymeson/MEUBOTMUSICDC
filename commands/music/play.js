...
module.exports = {
	...
	await inter.deferReply();
        ...
        try {
            ...
            return inter.editReply({ content: `não consigo entrar no canal de voz ${inter.member}... tente novamente! ❌`, ephemeral: true});
        }

       await inter.editReply({ content:`Carregando o seu ${res.playlist ? 'playlist' : 'track'}... 🎧`});
